...
public class PlayerStatus 
{
	...
	private int[] cumulativeTradeAway;
	private int[] cumulativeTradeGain;
	...
	public void updateCumulativeTrades(Offer off)
	{
		int[] get = null;
		int[] give = null;
		if (off.getPickedByIndex() == intPlayerIndex)
		{
			get = off.getOffer();
			give = off.getDesire();
		}
		else if (off.getOfferedByIndex() == intPlayerIndex)
		{
			get = off.getDesire();
			give = off.getOffer();
		}
		if (get != null && give != null)
		{
			...
			{
				cumulativeTradeAway[i] += give[i];
				cumulativeTradeGain[i] += get[i];
			}
		}
	}
	
	public int[] getCumulativeTradeAway()
	{
		return cumulativeTradeAway;
	}
	
	public int[] getCumulativeTradeGain()
	{
		return cumulativeTradeGain;
	}
	...
	public PlayerStatus( int intPlayerIndex, String strClassName, int[] aintInHand, double[] adblTaste )
	{
		...
		cumulativeTradeAway = new int[intColorNum];
		cumulativeTradeGain = new int[intColorNum];
	}
	...
	public double[] getAdblTaste()
	{
		return this.adblTaste;
	}
}
